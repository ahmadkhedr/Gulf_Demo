...
//
//     final mainDataModel = mainDataModelFromJson(jsonString);

import 'dart:convert';

MainDataModel mainDataModelFromJson(String str) => MainDataModel.fromJson(json.decode(str));
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    areaSpace: json["areaSpace"] == null ? null : json["areaSpace"],
    ...
    smsNo: json["smsNo"] == null ? null : json["smsNo"],
  );
